const _createClass = (() => { function defineProperties(target, props) {
...
} return (Constructor, protoProps, staticProps) => { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })();
...
const App = (() => {
  ...
  _createClass(App, [{
    ...
    value: function createDesign() {
      const id = document.getElementById('base_id');
      const name = document.getElementById('coc_name');
      const description = document.getElementById('coc_description');
      const image = document.getElementById('coc_image');
      const usn = document.getElementById('coc_usn');
      const datein = document.getElementById('coc_in');
      const dateout = document.getElementById('coc_out');
      const approve = document.getElementById('coc_approve');
    ...
    value: function approvePipoById(name) {
      const objects = [];
      const r = this.approvelist;
      for (let i = 0; i < r.length; i++) {
        const expr = r[i].name.toUpperCase().includes(name.toUpperCase());
        if (expr) {
          objects.push(r[i]);
        }
      }
...
const Component = (_App => {
  ...
  _createClass(Component, [{
    ...
    value: function pipoView(id) {
      const r = this.searchPipoById(id);
      let html = "\n                  ";
    ...
    value: function recentView(id) {
      const r = this.searchApproveId(id);
      let html = "\n\n                  ";
    ...
    value: function requestView(id) {
      const s = this.searchPipoById(id);
      let html = "";
    ...
    value: function pipoItems(name) {
      let html = "";
      const r = this.searchPipoId(name);
      for (let i = 0; i < r.length; i++) {
    ...
    value: function approveItems(name) {
      let html = "";
      const r = this.approvePipoById(name);
      for (let i = 0; i < r.length; i++) {
    ...
    value: function submitValidation() {
      ...
      const html = "\n                  ";
      const r = this.pipo;
      const a = document.getElementById("coc_name");
      const b = document.getElementById("coc_usn");
      const c = document.getElementById("coc_description");
      const d = document.getElementById("coc_out");
      const e = document.getElementById("coc_in");
    ...
    value: function validateForm() {
      const html = "\n\n                ";
      const UAN = $('#passinInput1').val();
      const PASS = $('#passinInput2').val();
      let msg = "Incorrect UAN or Password";
      let errFlag = true;
      let admin = {};
    ...
    value: function logoutValidation() {
      ...
      const logoutStatement = confirm("Are you sure you want to Log out?");
