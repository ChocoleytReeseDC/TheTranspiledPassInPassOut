	             ...
	             deleteApprove(key){
	                ...
	                updateApproveId(id){
	                	...
	                	this.approvelist.push(storageAppend);
	            ...
	            class Component extends App{
	            	...
	            	welcomeHome(){
	            		...
	            		this.render(`${html}`,document.getElementById("welcomeHome"));
	            	}
	            	...
	            	githubView(){
	            		...
	            		<div class="card-action">                  
	            		<center <span onclick="component.requestparty()" class="action-button shadow animate red"><i class="small material-icons">close</i>Close</span></center>                      </div>
	            		</div>
	            		</div>
	            		</div>
	            		</div>
	            	...
	            	fbView(){
	            		...
	            		`;
	            		this.reRender(``,document.getElementById("fbView"));
	            		$('#githubView').hide();
	            		$('#fbView').show();
	            		$('#updateApproveId').hide();
	            		$('#recentView').hide();
	            	...
	            	approveAdminView(id){
	            		...
	            		`;
	            		this.reRender(``,document.getElementById("approveAdminView"));
	            		$('#updateApproveId').hide();
	            		$('#approveView').hide();
	            	...
	            	pipoList(admin){
	            		...
	            		`;
	            		let r = this.pipo;
	            		for(let i=0;i<r.length-1; i>=0;i--){
	            			html+= `
	            	...
	            	approveItems(name){
	            		let html =``;
	            		let r = this.approvePipoById(name);
	            		for(let i =0; i <r.length; i++){
	            			html+=`
	            			<div class="col s6 m4">
	            			<div class="card">
	            		...
	            		this.reRender(``,document.getElementById("approveItems"));
	            		$('#updateApproveId').hide();
	            		$('#pipoList').hide();
	            		$('#pipoView').hide();
	            		$('#adminParty').hide();
	            ...
	            validateForm()
	            {
	            	...
	            	`;
	                let UAN = $('#passinInput1').val();
				      let PASS = $('#passinInput2').val();
	            ...
	            let logoutStatement = confirm("Are you sure you want to Log out?");
	            ...
	            requestparty(){
	            	...
	            	html+=`
						...
						<div class="s-12 l-4 post-text">
						   ...
						   <p>This is the Latest Request that the user submbitted to the system. He/she is recommended to wait for the approval of the adminisrator so he can freely pass in and out the campus.                     </p>
						</div>
						</article>         
						<article class="post-5 right-align line">
						<div class="s-12 l-5 post-text">
